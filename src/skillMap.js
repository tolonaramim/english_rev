const SKILL_MAP = [
  ...
  },
  {
    ...
    items: [
      ...
      'idea boosters',
      'idea boosters: abilities or capabilities',
      'idea boosters: characteristics',
      'idea boosters: suggestions',
      'idea boosters: dependency',
      'idea boosters: differences',
      'idea boosters: other relevant factors',
